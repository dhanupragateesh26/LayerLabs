  ...
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#09090b;color:#e5e7eb;padding:32px;border-radius:12px;border:1px solid #27272a;">
      ...
      <div style="background:#18181b;border:1px solid #27272a;border-radius:8px;padding:20px;margin:24px 0;">
        ...
        <p style="color:#22c55e;margin:0 0 14px;font-size:12px;text-transform:uppercase;letter-spacing:0.08em;font-weight:700;">Order Summary</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <tr><td style="color:#6b7280;padding:5px 0;width:40%;">Order ID</td><td style="color:#4ade80;font-family:monospace;">${order._id}</td></tr>
        ...
        <div style="margin-top:16px;padding-top:16px;border-top:1px solid #27272a;">
          <p style="color:#22c55e;margin:0 0 5px;font-size:12px;text-transform:uppercase;letter-spacing:0.08em;font-weight:700;">File Access</p>
          <a href="${downloadUrl}" style="color:#4ade80;text-decoration:none;font-size:13px;">⬇️ Click here to download the .STL file</a>
        </div>
      </div>
